        ...
        {step === 1 && (
          <div className="space-y-6 animate-txn-in">
            ...
            <div className="text-center p-6 bg-[#F9FAFB]/50 rounded-xl border border-gray-200">
              ...
              <h3 className="text-lg font-bold text-gray-900">{usage.user_name || "No Name"}</h3>
              <p className="text-sm text-gray-500 mb-3">{usage.user_email || "Unknown User"}</p>
              <div
                className={`text-[32px] font-bold my-2 ${
                  isAtLimit ? "text-red-500" : isHigh ? "text-amber-500" : "text-emerald-500"
                }`}
              >
                {usage.total_used} <span className="text-xl text-gray-400">/ 25</span>
              </div>
            ...
            <div>
              <h4 className="text-[11px] font-semibold text-gray-700 mb-3 uppercase tracking-[0.04em]">AI Features Usage</h4>
            ...
            {/* Usage Date Info */}
            <div>
              <h4 className="text-[11px] font-semibold text-gray-700 mb-3 uppercase tracking-[0.04em]">Usage Information</h4>
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                <div className="p-5 space-y-0 divide-y divide-gray-100">
                  <DetailRow 
                    label="Date" 
          ...
          <div className="space-y-6 animate-txn-in">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between p-3 bg-[#F9FAFB]/50 rounded-lg border border-gray-100">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg flex items-center justify-center border border-gray-100 bg-white">
                ...
                <div className="flex items-center justify-between p-3 bg-[#F9FAFB]/50 rounded-lg border border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-gray-900">Usage Status</div>
                      <div className="text-[10px] text-gray-400">
            ...
            <div>
              ...
              <div className="bg-[#F9FAFB]/50 rounded-lg p-4 border border-gray-100">
                <p className="text-[11px] text-gray-500 leading-relaxed font-mono break-all">
                  {usage.id}
                </p>
              </div>
            </div>
