...
interface EditAdminChatbotModalProps {
    open: boolean;
    onClose: () => void;
    onSuccess: () => void;
...
export function EditAdminChatbotModal({ open, onClose, onSuccess, message }: EditAdminChatbotModalProps) {
    ...
    // Pre-populate form data when message changes
    useEffect(() => {
        if (message && open) {
            setFormData({
                ...
                {currentStep === 1 && (
                    <div className="animate-txn-in">
                        <div className="mb-5">
                            ...
                            <p className="text-[11px] text-gray-500">Change the user for this chat message.</p>
                        </div>
                ...
                {currentStep === 3 && (
                    <div className="animate-txn-in">
                        <div className="mb-5">
                            ...
                            <p className="text-[11px] text-gray-500 mt-1">Review the updated details before saving.</p>
                        </div>
                            ...
                            <div className="bg-white border border-slate-200 rounded-xl p-4">
                                ...
                                <div className="flex items-center gap-3">
                                    {selectedUser ? (
                                        ...
                                        <div>
                                            <p className="text-[13px] font-bold text-slate-900">{message?.user_name || "No Name"}</p>
                                            <p className="text-[11px] text-slate-500">{message?.user_email || formData.user_id}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                                ...
                                <div className="flex gap-2.5 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[11px] text-slate-600 leading-relaxed">
                                            This will update the message in the user's chat history. The changes will be immediately visible.
                                        </p>
                                    </div>
                                </div>
                            </div>
