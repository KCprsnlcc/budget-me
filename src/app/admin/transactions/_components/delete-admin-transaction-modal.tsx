      ...
      <ModalBody className="px-5 py-8 bg-[#F9FAFB]/30">
        <div className="text-center animate-txn-in">
          ...
          <p className="text-sm text-gray-500 mb-6 max-w-xs mx-auto leading-relaxed">
            Are you sure you want to delete this transaction? This action cannot be undone and will permanently remove the transaction from the user's records.
          </p>
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden mx-auto max-w-sm">
            <div className="p-5 space-y-0 divide-y divide-gray-100">
              ...
              <div className="flex justify-between items-center py-2.5">
                ...
                <span className="text-sm font-semibold text-gray-700">{transaction.user_email ?? "Unknown"}</span>
              </div>
              <div className="flex justify-between items-center py-2.5">
          ...
          <div className="p-3 rounded-lg text-xs bg-white border border-gray-200 text-gray-700 mx-auto max-w-sm mt-6">
            <div className="flex gap-2.5 items-start">
              ...
              <div>
                <h4 className="font-bold text-[10px] uppercase tracking-widest mb-0.5 text-gray-900">Admin Action</h4>
                <p className="text-[11px] leading-relaxed">
                  This transaction will be permanently deleted from the user's account and cannot be recovered. This action may affect the user's budget and goal progress.
                </p>
              </div>
            </div>
          </div>
