            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
                <div className="p-5 space-y-0 divide-y divide-gray-100">
                  ...
                  {accountBalance !== undefined && transaction && (
                    <ReviewRow 
                      label="New Balance" 
                      value={`₱${(accountBalance - transaction.amount + (form.type === "income" ? parseFloat(form.amount || "0") : -parseFloat(form.amount || "0"))).toFixed(2)}`} 
                    />
                  )}
